...
Revision ID: b1e63e781920
Revises: 
Create Date: 2024-05-22 00:00:43.685681
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('atomy_id', 'warehouse_id', name='idx_unique_atomy_id_warehouse_id')
    )
